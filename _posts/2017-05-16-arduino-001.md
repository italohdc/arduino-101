...
Lembrando que a linguagem de programação utilizada pela Arduino IDE compartilha várias funções em comum com a linguagem C++. Caso você não tenha muito conhecimento sobre a linguagem C++, a próxima aula irá explicar um pouco mais sobre os comandos básicos dessa linguagem.
